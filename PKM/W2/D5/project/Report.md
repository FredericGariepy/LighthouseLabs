...
| [HTTP Apache ModStatus PerfStats Sensor](https://www.paessler.com/manuals/prtg/http_apache_modstatus_perfstats_sensor) | The HTTP Apache ModStatus PerfStats sensor monitors performance statistics of an Apache web server over HTTP.          | Linux OS: Ubuntu (debian) 22.04.4 LTS (Jammy Jellyfish). Developer Server |                                                                                                                           | Attackers may try to attack the availability of the Apache 2 server.                                                         | Moderate                  | CPULoad, Workers Idle/Busy, Requests Per Second, UP/DOWN time                                                                                                                                  |
